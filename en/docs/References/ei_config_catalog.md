                ...
                <div class="params-wrap">
                        ...
                        <div class="param-info">
                            ...
                            <div class="param-description">
                                ...
                                <details class="warning classes" open="open">
                                    ...
                                    However, if there are two servers running on the same machine, ensure that a unique port is set for each server. For example, you can have port 4100 for node 1 and port 4200 for node 2.</p>
                                </details>
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="param">
                        ...
                        <div class="param-info">
                            ...
                            <div class="param-description">
                                <p>Add this parameter to change the default membership scheme. By default, the well-known address regsitraion method (WKA) is used, which ensures that each node sends cluster initiation messages to the WKA members.</p>
                            </div>
                        </div>
                    </div>
                    <div class="param">
...
<div class="mb-config-catalog">
    <section class="title">
        <div class="mb-config-options">    
            <h2>Configuring the system administrator</h2>
        </div>
        <div class="mb-config-example"></div>
    </section>
    <section>
                    ...
                    <div class="param">
                        ...
                        <div class="param-info">
                            <div>
                                ...
                                <div class="param-default">
                                	<span class="param-default-value">"admin"<span>
                                </div>
                            </div>
                            <div class="param-description">
                                <p>The password of the system adminsitrator.</p>
                            </div>
                        </div>
                    </div>
                    <div class="param">
