...
3.  Save the Siddhi file so that you can run it in the Run or Debug mode.
    ...
    2.  Start the application in the Debug mode, click **Run** =\>
        **Debug** . As a result, the following mesage is logged in the
        ...
        with debug options.  
        ![Console with Debug Tab](../images/Testing-Siddhi-Applications/Console-with_Debug-Tab.png)
...
!!! tip
    ...
    debug it. Therefore, before you try this section, see 
    [Running or debugging a Siddhi application](testing-a-Siddhi-Application.md#Running-or-debugging-a-Siddhi-application).
...
1.  Access the Streaming Integrator Studio via the `http://localhost:/editor`
    ...
    ![SI Studio Welcome Page](../images/Testing-Siddhi-Applications/Stream_Processor_Studio_Welcome_Page.png)  
...
3.  Enter Information in the **Single Simulation** panel as described
    ...
    3.  If you want to simulate the event for a specific time different
        ...
        **Timestamp** field. To select a timestamp, click the time and
        ...
        Then select the required date, hour, minute, second and millisecond. Click
...
4.  Click **Send** to start sending the event. The simulated event is
...
5.  Enter values for the displayed fields as follows.
    ...
    4.  If you want to enter more advanced conditions to simulate the
        ...
        ![Advanced onfigurations](../images/Testing-Siddhi-Applications/Feed_Simulation_Database_Advanced.png){width="442"
        height="191"}  
    ...
    6.  Once you have entered the above information, click **Connect to
        ...
        following is displayed to indicate that Streaming Integrator can successfully
...
7.  Click on the play button of this simulation to open the **Run or
    Debug** dialog box.  
    ![Run or Debug dialog box](../images/Testing-Siddhi-Applications/Run_Or_Debug..png)
