...
A Basic Authentication handler is enabled in the Micro Integrator by default. See the example on [securing an API with basic auth](../../../use-cases/examples/rest_api_examples/securing-rest-apis).
