...
1.  Select the already created [**Datasource Config module**](../../../../develop/create-datasources/) in the project navigator, right-click, and go to **New -> Datasource**.
...
2.  Select your [**datasource config module**](../../../../develop/create-datasources/) as the **Container**, add the file name for your datasource, and click **Finish**.
