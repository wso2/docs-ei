...
1.  Open the <b>Getting Started</b> view and click click <b>Miscellaneous</b> →<b>Add new Server</b> to open the <b>New Server</b> dialog.
    
    <img src="../../assets/img/testing-integrations/is_getting_started_page.png" width="700">

2.  In the <b>New Server</b> dialog that opens, expand the WSO2 folder and select the version of your server.

    <img src="../../assets/img/testing-integrations/new-server-choose-type.png" width="500">

3.  Click <b>Next</b>. In the CARBON_HOME field, provide the path to your product's home directory and then click <b>Next</b> again.
