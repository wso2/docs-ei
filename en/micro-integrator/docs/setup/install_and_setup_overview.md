...
-	[Compare the EI 7.1 Micro Integrator with the ESB](../../setup/deployment/runtime-comparison-esb-mi)
-	[Migrating from WSO2 ESB 5.x](../../setup/deployment/migrating-from-ei-6.x.x)
