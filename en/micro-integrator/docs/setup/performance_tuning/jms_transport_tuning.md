...
-   [Increase the maximum number of JMS
    proxies](#TuningtheJMSTransport-IncreasethemaximumnumberofJMSproxies)
-   [Configuring JMS
    Listener](#TuningtheJMSTransport-ConfiguringJMSListener)
-   [Configuring JMS
    Sender](#TuningtheJMSTransport-ConfiguringJMSSender)
-   [Troubleshooting JMS
    scenarios](#TuningtheJMSTransport-TroubleshootingJMSscenarios)
...
[Back to Top ^](#TuningtheJMSTransport-toc)
...
.) For example, if the topic name is `         my::topic        ` , the
