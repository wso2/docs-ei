...
??? note "deleteObject"
    ...
    <table>
        ...
        <tr>
            <td>bucketUrl</td>
            <td>End point URL of the request.</td>
            <td>Yes</td>
        </tr>
        <tr>
            <td>objectName</td>
...
??? note "deleteMultipleObjects"
    ...
    <table>
        ...
        <tr>
            <td>deleteConfig</td>
            <td>Contains the objects that are suppose to be deleted.</td>
            <td>Yes</td>
        </tr>
        <tr>
            <td>quiet</td>
            <td>Element to enable quiet mode for the request.</td>
            <td>Yes</td>
        </tr>
    </table>
...
??? note "createObjectACL"
    ...
    <table>
        ...
        <tr>
            <td>accessControlList</td>
            <td>Container for ACL information.</td>
            <td>Yes</td>
        </tr>
        <tr>
            <td>versionId</td>
...
??? note "uploadPart"
    ...
    <table>
        ...
        <tr>
            <td>partNumber</td>
            <td>This specifies the number or the index of the uploaded part.</td>
            <td>Yes</td>
        </tr>     
        <tr>
            <td>body</td>
    ...
    **Sample request**
    ...
    ```xml
    http://localhost:8889/services/multipart?objectName=testFile1.txt&uploadId=VSMdi3EgFYBq_DpBv6G0LWXydidqO9WIw90UIp81EripQrJNuxOo.jf3tkA.23aURwTOZPBD4iCfcogwtMc8_A--&partNumber=1&bucketUrl=http://sinhala.com.s3-us-west-2.amazonaws.com&accessKeyId=XXXXX&secretAccessKey=XXXXXX&bucketName=sinhala.com&isXAmzDate=true&methodType=PUT
    ``` 
...
??? note "listParts"
    ...
    <table>
        ...
        <tr>
            <td>uploadId</td>
            <td>Upload ID identifying the multipart upload whose parts are being listed.</td>
            <td>Yes</td>
        </tr>
        <tr>
            <td>encodingType</td>
        ...
        <tr>
            <td>maxParts</td>
            <td>Sets the maximum number of parts to return in the response body.</td>
            <td>Yes</td>
        </tr>
        <tr>
            <td>partNumberMarker</td>
            <td>Specifies the part after which listing should begin.</td>
            <td>Yes</td>
        </tr>       
    </table>
...
??? note "getObjectACL"
    The getObjectACL operation uses the ACL subresource to return the access control list (ACL) of an object. To use this operation, you must have READ_ACP access to the object. See [related API documentation](http://docs.aws.amazon.com/AmazonS3/latest/API/RESTObjectGETacl.html) for more information.
    <table>
        <tr>
            <th>Parameter Name</th>
            <th>Description</th>
...
??? note "getObjectTorrent"
    The getObjectTorrent operation uses the torrent subresource to return torrent files from a bucket. BitTorrent can save you bandwidth when you're distributing large files. You can get torrent only for objects that are less than 5 GB in size and that are not encrypted using server-side encryption with customer-provided encryption key. To use this operation, you must have READ access to the object. See [related API documentation](http://docs.aws.amazon.com/AmazonS3/latest/API/RESTObjectGETtorrent.html) for more information.
    <table>
        <tr>
            <th>Parameter Name</th>
            <th>Description</th>
