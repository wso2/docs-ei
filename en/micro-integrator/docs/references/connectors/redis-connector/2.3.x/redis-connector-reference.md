...
??? note "redis.init - Cluster mode"
    ...
    **Sample configuration**
    ...
    ```
??? note "redis.init - Redis Sentinel"
    The redis.init operation initializes the connector to interact with Redis Sentinel implementation.
    <table>
        <tr>
            <th>Parameter Name</th>
            <th>Description</th>
        ...
        <tr>
            ...
            <td>A flag to enable the redis Sentinel mode (Default is false).</td>
            <td>Yes</td>
        </tr>
        <tr>
            <td>masterName</td>
            <td>Name of the Redis master node</td>
            <td>Yes</td>
        </tr>
        <tr>
            <td>sentinels</td>
            <td>A comma separated list of sentinels eg: 127.0.0.1:26379,127.0.0.1:26389</td>
            <td>Yes</td>
        </tr>
        <tr>
            <td>masterPassword</td>
            <td>Password of the master node</td>
            <td>Optional</td>
        </tr>
        <tr>
            <td>dbNumber</td>
            <td>The number of the DB</td>
            <td>Optional</td>
        </tr>
    </table>
