...
The user calls the Salesforcerest API. It invokes the **create** sequence and create a new account in Salesforce. Then through the **retrieve** sequence, it displays all the existing account details to the user. 
