# Exporting artifacts
In this document we focus on creating the Connector Exporter Project and Exporting the CApp. 
...
5. Once you are directed to the workspace, it will display all the connectors which exist in the workspace. You can select the relevant connector and click **Ok**. 
...
1. Now right click on Composite Application Project and click on **Export Composite Application Project**
