...
3. In the next **Create a deployable CAR file** screen, select the both created ESB Solution Project and the Connector Exporter Project to save as below and click **Finish**. The CApp will get created at the specified location provided at the previous step. 
