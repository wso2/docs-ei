...
[Configure the Connector and the Connector Exporter Project](../importing-connector-to-integration-studio.md).
...
4. Follow these steps to [export the artifacts](../exporting-artifacts.md).
...
```
2. Invoke the API as below using curl. It can be downloaded from [Releases and Downloads](https://curl.haxx.se/download.html).
```
