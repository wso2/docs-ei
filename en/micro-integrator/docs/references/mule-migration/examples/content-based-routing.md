...
<img width="60%" src="../../../assets/img/migration-examples/content-based-routing-use-case.png">
...
6. The **ContentBasedRoutingAPI.xml** is the graphical view of the content based routing sample.<br>
    <img width="60%" src="../../../assets/img/migration-examples/content-based-routing.png">
...
<a href="../../../assets/zip/mule-migration/content-based-routing.zip" download>
