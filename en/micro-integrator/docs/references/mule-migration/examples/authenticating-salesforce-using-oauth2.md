---
title: Authenticating Salesforce using OAuth 2.0
...
<img width="70%" src="../../../assets/img/migration-examples/authenticating-salesforce-using-oauth2-use-case.png">
...
4. Browse and select the file path to the downloaded sample of this Github project (`integration-studio-examples/migration/mule/authenticating-salesforce-using-oauth2/AuthenticatingSalesforceUsingOauth2Registry`) and click **finish**.
...
7. Open the **ContactsAPI.xml** under **authenticating-salesforce-using-oauth2/AuthenticatingSalesforceUsingOauth2/src/main/synapse-config/api/** directory.<br>
    <img width="70%" src="../../../assets/img/migration-examples/authenticating-salesforce-using-oauth2.png">
...
<a href="../../../assets/zip/mule-migration/authenticating-salesforce-using-oauth2.zip" download>
