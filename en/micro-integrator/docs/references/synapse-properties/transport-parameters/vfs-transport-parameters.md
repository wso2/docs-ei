...
When you implement an integration use case that requires file processing, you can use the following VFS parameters in your [proxy service](../../../../develop/creating-artifacts/creating-a-proxy-service) artifact.
