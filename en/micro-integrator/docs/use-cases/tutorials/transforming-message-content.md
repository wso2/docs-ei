...
11. Now, you need to map the input message with the output message. There are two ways to do the mapping:
    - If you click **Apply**, the mapping will be generated by the **AI Data Mapper**. You have the option to manually change the generated mapping.
    - You can also manually draw the mapping by dragging arrows from the field values in the **Input** box to the relevant field values in the **Output** box.  
