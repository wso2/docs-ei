...
!!! Info
    The following logging resources are available as a product update from **10th June, 2020** onwards. See the instructions on [getting product updates](https://docs.wso2.com/display/updates/Getting+Started).
